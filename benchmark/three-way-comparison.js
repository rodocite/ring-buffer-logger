...
const runThreeWayComparison = () => {
  ...
  console.log('Original vs Optimized vs Ultra-Optimized');
  ...
  const implementations = [
    ...
    { name: 'Optimized', Logger: OptimizedLogger, dir: './bench-optimized' },
    { name: 'Ultra', Logger: UltraLogger, dir: './bench-ultra' }
  ];
  ...
  for (const testCase of tests) {
    ...
    const optimizedSpeedup = (baseline / results['Optimized'].time).toFixed(2);
    const ultraSpeedup = (baseline / results['Ultra'].time).toFixed(2);

    console.log(`\n🚀 Speedups: Optimized ${optimizedSpeedup}x, Ultra ${ultraSpeedup}x`);
  }
...
const quickTest = () => {
  ...
  const tests = [
    ...
    { name: 'Optimized', Logger: OptimizedLogger, dir: './quick-optimized' },
    { name: 'Ultra', Logger: UltraLogger, dir: './quick-ultra' }
  ];
